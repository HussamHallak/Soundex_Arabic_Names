...
barplot(all, beside = TRUE, main = "Measures based on single direction names matching", xlab = "Metric", ylim = c(0,1), ylab = "Value", col = c("dodgerblue3", "green", "black", "orange", "skyblue1", "red"), legend.text = rownames(all),  xlim = c(0,55), args.legend = list(cex=0.8,x = "topright"))
